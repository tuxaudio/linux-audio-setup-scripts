...
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/tuxaudio/linux-audio-setup-scripts/main/ubuntu/2204/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
