#!/bin/bash
# ---------------------------
# This is a bash script for configuring Ubuntu (25.10 / quokka) for pro audio USING PIPEWIRE.
# ---------------------------
# NOTE: Execute this script by running the following command on your system:
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/tuxaudio/linux-audio-setup-scripts/main/ubuntu/2510/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
