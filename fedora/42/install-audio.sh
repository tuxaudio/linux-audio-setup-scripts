#!/bin/bash
# ---------------------------
# This is a bash script for configuring Fedora 42 for pro audio USING PIPEWIRE.
# ---------------------------
# NOTE: Execute this script by running the following command on your system:
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/brendaningram/linux-audio-setup-scripts/main/fedora/42/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
