...
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/tuxaudio/linux-audio-setup-scripts/main/fedora/37/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
