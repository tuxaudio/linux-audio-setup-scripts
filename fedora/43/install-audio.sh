...
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/brendaningram/linux-audio-setup-scripts/main/fedora/43/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
