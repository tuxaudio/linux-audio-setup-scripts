#!/bin/bash
# ---------------------------
# This is a bash script for configuring Zorin OS 18 for pro audio using PIPEWIRE.
# ---------------------------
# NOTE: Execute this script by running the following command on your system:
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/brendaningram/linux-audio-setup-scripts/main/zorin/18/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
...
# ---------------------------
notify "REAPER"
wget -O reaper.tar.xz http://reaper.fm/files/7.x/reaper749_linux_x86_64.tar.xz
mkdir ./reaper
