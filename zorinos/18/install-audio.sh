...
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/tuxaudio/linux-audio-setup-scripts/main/zorin/18/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
...
# ---------------------------
notify "REAPER"
wget -O reaper.tar.xz http://reaper.fm/files/7.x/reaper752_linux_x86_64.tar.xz
mkdir ./reaper
