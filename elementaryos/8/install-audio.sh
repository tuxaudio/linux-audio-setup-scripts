#!/bin/bash
# ---------------------------
# This is a bash script for configuring ElementaryOS (8 / noble) for pro audio USING PIPEWIRE.
# ---------------------------
# NOTE: Execute this script by running the following command on your system:
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/tuxaudio/linux-audio-setup-scripts/main/elementaryos/8/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
...
# ---------------------------
notify "REAPER"
wget -O reaper.tar.xz http://reaper.fm/files/7.x/reaper755_linux_x86_64.tar.xz
mkdir ./reaper
